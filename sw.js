...
const ASSETS = [
  ...
  '/articles/watermelon-juice-benefits.html',
  '/articles/beetroot-gym-guide.html',
  '/articles/ginger-gym-recovery.html',
  '/articles/cold-pressed-benefits.html',
  '/css/style.css',
  '/js/main.js',
  '/manifest.json'
];
